...
class TestMessageEdit(MailMessageCommon):
    ...
    def test_default_edit_message(self):
        ...
        self.assertEqual(wizard.body, Markup("<p>Test Body Child</p>"))
        self.assertTrue(wizard.can_edit, msg="Can_edit must be True")
        wizard = Form(
        ...
        self.assertEqual(wizard.body, Markup("<p>Test Body Parent</p>"))
        self.assertTrue(wizard.can_edit, msg="Can_edit must be True")
        wizard = Form(EditWiz).save()
        self.assertFalse(wizard.message_id, msg="Message must be empty")
        self.assertFalse(wizard.can_edit, msg="Can_edit must be False")
        self.assertFalse(wizard.body, msg="Can_edit must be False")
