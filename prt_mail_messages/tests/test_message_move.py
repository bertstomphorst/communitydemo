...
class TestMessageEdit(MailMessageCommon):
    ...
    def test_message_move(self):
        ...
        move = Form(MessageMove.with_context(active_model="crm.lead")).save()
        self.assertFalse(move.is_lead)
        self.assertFalse(move.is_conversation)
        move = Form(
        ...
        self.assertFalse(move.is_lead)
        self.assertFalse(move.is_conversation)
        move = Form(MessageMove.with_context(active_model="cetmix.conversation")).save()
        self.assertFalse(move.is_lead)
        self.assertTrue(move.is_conversation)
